...
<body>
    ...
    <form class="form-login" method="POST" action="{{ route('login.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" id="email" placeholder="correo@gmail.com" value="{{old('email')}}">
        ...
        <div class="form-button-group">
            ...
            <a class="btn btn-primary" href={{url('signin')}}>Registrarse</a>
        </div>
    </form>
